...
// Pages NOT in this set for a given role are hidden from the sidebar
// and blocked if navigated to directly.
...
export function canAccess(role, page) {
  ...
  if (!allowed) return true;          // no restriction defined → full access
...
export default function Sidebar({ currentPage, onNavigate, user, onLogout, notifCount, profileDropdownOpen, onToggleProfile }) {
  ...
  // Filter items the current role may see
