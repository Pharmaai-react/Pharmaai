...
import { registerUser, isUsernameAvailable } from '../userStore.js';
...
export default function SignUpPage({ onSignUp, onGoToLogin }) {
  const [step, setStep] = useState(1); // step 1 = account, step 2 = pharmacy
            ...
            <div className="form-group">
              <label className="form-label">
                ...
                {usernameStatus === 'taken' && (
                  <span className="username-status taken"> ✗ Already taken</span>
                )}
