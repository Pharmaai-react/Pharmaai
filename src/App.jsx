...
export default function App() {
  ...
  const handleSaleComplete = useCallback((cartItems) => {
    ...
    <>
      <div className="app-container">
        ...
        <main className="main-content">
          ...
          {currentPage === 'interactions' && <InteractionsPage />}
          {currentPage === 'sell' && (
            <SellPage
          ...
          {currentPage === 'settings' && (
            <SettingsPage user={currentUser} onLogout={handleLogout} showNotification={showNotification} />
          )}
          {currentPage === 'notifications' && (
            <NotificationsPage onMarkAllRead={() => { setNotifCount(0); showNotification('All notifications marked as read.'); }} />
          )}
        </main>
      </div>
